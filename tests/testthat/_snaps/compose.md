# compose_comment works
    ...
    Output
      ...
      :white_check_mark:  Merging PR [#3](https://github.com/dragosmg/covr2ghdemo/pull/3) ([`<removed-commit-sha>`](head_sha_url)) into _main_ ([`<removed-commit-sha>`](base_sha_url)) - will **increase** coverage by `21.05` percentage points.
      ...
      <sup>Created on <removed-date> with [covr2gh v0.0.0.9016](https://dragosmg.github.io/covr2gh).</sup>
